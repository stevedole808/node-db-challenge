...
Rational databases are ways to manage a database using different tables while SQL is a language.
- [ ] Why do tables need a `primary key`?
It is used as a autoincrementing id for each specific entry/user to a database table.
